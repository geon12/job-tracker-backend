...
microsoft = Organization.create({name:"Microsoft", description:"Tech Company",industry:"tech"})
...
app1 = JobApplication.create({notes:"djnnrgrjkwnrkejg",job:job1,user:user1,status:"Need to Submit Application",rejected:false,application_process:"referred"})
app2 = JobApplication.create({notes:"njvnjrrjngodvjew",job:job2,user:user2,status:"Waiting for Response",rejected:false,application_process:"online"})
